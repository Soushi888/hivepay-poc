<script lang="ts">
	...
	let merchantImage =
		'https://images.hive.blog/p/FxX5caie56ynwsjysm2XuNozdMysq1YNDRbt9X9VeerNm1981Q9QbBMAae56reruh3oPEPxXcntWKcGMSHj6xjDsn1Q6pWLBn3bCbY8qCcCe?width=128&height=128';
...
<form method="post" action={apiUrl} target="hivepay-popup" bind:this={form}>
	...
	<input
		type="image"
		on:click={openHivePayWindow}
		src="https://hivepay.io/buttons/16.png"
		alt="Pay With HivePay"
	/>
</form>
